...
// CTRL_MEAS Register Configuration Bit Masks and Values
...
// CONFIG Register Configuration Bit Masks and Values
...
// NUEVA FUNCIÓN PÚBLICA para leer un solo byte de registro
uint8_t BMP280_read_register_byte(uint8_t reg_addr); // <--- AÑADIR/VERIFICAR ESTA LÍNEA
